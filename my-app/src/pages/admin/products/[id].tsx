    ...
    <form className="justify-center w-full mx-auto" method="post" onSubmit={handleSubmit(onSubmit)}>
        <div className="">
            ...
            {/* <div className=" mb-[10px]">
                    ...
                    <label htmlFor="Name" className="block mb-3 text-sm font-semibold text-gray-500">Category</label>
                    <input type="text" {...register('category', { required: true})} placeholder="...." className="w-full px-4 py-3 text-sm border border-gray-300 rounded lg:text-sm focus:outline-none focus:ring-1 focus:ring-blue-600" />
                    {errors.category && <span className='text-red-500'>Không để trống và nhập lớn hơn 5</span>}
                </div>
                <div className="w-full mb-[10px]">
