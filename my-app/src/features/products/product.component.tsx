...
import { nameProducts } from '../../features/products/product.slice'
import Link from "next/link";
import { useAppSelector } from "../../app/hook";
import { getCategory } from "../category/category.slice";
        ...
        <ol className="inline-flex items-center space-x-1 md:space-x-3">
          ...
          <li>
            <div className="flex items-center">
              ...
              <a href="#" className="ml-1 text-[25px] font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Products</a>
            </div>
          </li>
        </ol>
      </nav>
          ...
          <div className="overflow-y-auto py-4 px-3 bg-cyan-200 rounded dark:bg-cyan-200">
            <div className="">
              ...
              <div className="relative mb-[30px]">
                ...
                <input type="text" onChange={(e) => searchName(e.target.value)} id="form-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-80 pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 outline-none" placeholder="Search name product" />
              </div>
            </div>
            <ul className="space-y-2">
              ...
              <li>
                <a href='' className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-black active:bg-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700">
                  <span className="flex-1 ml-3 whitespace-nowrap font-bold">ALL PRODUCTS</span>
                </a>
              </li>
              {categorys?.map((item, index) => {
                return (
                  <li key={index}>
                    <a href="" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-blue-700 active:bg-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700">
